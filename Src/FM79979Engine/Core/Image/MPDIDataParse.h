...
#else
	char*	TexBehaviorDataWithImageIndexDataToString(sTexBehaviorDataWithImageIndexData e_sTexBehaviorDataWithImageIndexData,sPuzzleData*e_pAllPuzzleData,int e_iNumData);
	void	ExportPointDataList(ATG::XMLWriter*e_pXMLWriter,cCueToStartCurveWithTime*e_pCueToStartCurvesWithTime);
#endif
